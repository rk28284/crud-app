...
employeeRouter.post("/employee/add",authmiddleware, async (req, res) => {
...
employeeRouter.get("/employee",authmiddleware, async (req, res) => {
  try {
...
employeeRouter.get("/employee/:id", authmiddleware, async (req, res) => {
...
employeeRouter.delete("/employee/delete/:id", authmiddleware, async (req, res) => {
...
employeeRouter.patch("/employee/update/:id", authmiddleware, async (req, res) => {
  const ID = req.params.id;
